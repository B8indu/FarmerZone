...
3. Copy the `FarmerZone` project folder.
4. Paste it inside:
C:\xampp\htdocs\
...
7. Create a new database (example: farmerzone).
8. Import the provided SQL file into the database.
9. Open browser and run:
    
http://localhost/FarmerZone
